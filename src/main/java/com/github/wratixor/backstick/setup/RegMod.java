...
public class RegMod {
    ...
    public static final RegistryObject<Item> STONE_BACKSTICK = ITEMS.register("stone_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.COMMON)));
    public static final RegistryObject<Item> COPPER_BACKSTICK = ITEMS.register("copper_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> IRON_BACKSTICK = ITEMS.register("iron_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> GOLDEN_BACKSTICK = ITEMS.register("golden_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> DIAMOND_BACKSTICK = ITEMS.register("diamond_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> NETHERITE_BACKSTICK = ITEMS.register("netherite_backstick", () -> new Item(new Item.Properties().tab(SetMain.MODE_TAB).stacksTo(64).rarity(Rarity.EPIC)));
    public static final RegistryObject<Item> WOODEN_BACKBREACKER = ITEMS.register("wooden_backbreacker", () -> new DurabilityCraftingItem(Tiers.WOOD, Rarity.COMMON));
    ...
    public static final RegistryObject<Item> WOODEN_BACKENGRAVER = ITEMS.register("wooden_backengraver", () -> new DurabilityCraftingItem(Tiers.WOOD, Rarity.COMMON));
    ...
    public static final RegistryObject<Item> WOODEN_BACKMUTATOR = ITEMS.register("wooden_backmutator", () -> new DurabilityCraftingItem(Tiers.WOOD, Rarity.COMMON));
